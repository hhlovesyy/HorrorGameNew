...
//repo's address:https://github.com/oodavy41/randomMapDemo
//documentation:https://indienova.com/u/cocolate/blogread/1493
public class HMazeGeneration : MonoBehaviour
{
    public int width;
    public int height;
    ...
    private int[,] poss;
    public GameObject[,] wallsAndPaths;
    ...
    public GameObject wallOrRoadPrefab;
    ...
    void Start()
    {
        ...
        wallsAndPaths = new GameObject[width, height];
        ...
        for (int i = 0; i < width; i++)
        {
            for (int j = 0; j < height; j++)
            {
                ...
                //     GameObject.Instantiate(wallOrRoadPrefab, startPos.position + new Vector3(i, 0, j),quaternion.identity);
                //wallsAndPaths[i, j] = wallOrRoad;
            }
        }
        ...
        if (map != null)
        {
            for (int x = 0; x < width*2-1; x++)
            {
                for (int y = 0; y < height*2-1; y++)
                {
                    ...
                    // if (x == startx && y == starty) Gizmos.color = Color.green;
                    // else if(x == endx && y == endy) Gizmos.color=Color.red;
                    //
